...
export const getLinkedDataPoint = (dataPointsToHideFromList?: DataPoint[]) => {
  return new Promise<DataPoint | undefined>((resolve, reject) => {
    ...
    dataPoints.forEach(point => {
      if (dataPointsToHideFromList === undefined || !dataPointsToHideFromList.includes(point)) {
    ...
    vscode.window
      .showQuickPick(selectableDataPoints, { placeHolder: 'Select another Data Point to link to' })
